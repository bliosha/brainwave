...
export const Gradient = () => {
  return (
    <div className="pointer-events-none absolute -left-[10rem] top-0 h-[56.625rem] w-[56.625rem] opacity-50 mix-blend-color-dodge">
      <img
        className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 top-1/2 h-[88.5625rem] w-[79.5625rem] max-w-[79.5625rem]"
        src={gradient}
        width={1417}
        height={1417}
        alt="Gradient"
...
export const PhotoChatMessage = () => {
  return (
    <div className="font-code absolute right-8 top-8 max-w-[17.5rem] rounded-t-xl rounded-bl-xl bg-black px-8 py-6 text-base lg:top-16 lg:right-[8.75rem] lg:max-w-[17.5rem]">
...
export const VideoChatMessage = () => {
  return (
    <div className="bg-n-6 font-code absolute left-[3.125rem] top-8 w-full max-w-[14rem] rounded-t-xl rounded-br-xl pb-7 pl-5 pr-2.5 pt-2.5 text-base md:max-w-[17.5rem]">
      ...
      <p className="tagline text-n-3 absolute bottom-1 right-2.5 uppercase text-[0.625rem]">
        just now
      </p>
      <ChatBubbleWing
        className="-scale-x-100 absolute bottom-0 right-full"
