    ...
    return (
        <Section id="features">
            <div className="z-2 container relative">
                ...
                <div className="mb-10 gap-10 flex flex-wrap">
                    {benefits.map((item) => (
                        <div
                            className="p-0.5 relative block bg-no-repeat md:max-w-[24rem] bg-[length:100%_100%]"
                            style={{
                            ...
                            <div
                                className="bg-n-8 inset-0.5 absolute"
